...
public class RavenTargetHUD extends SubMode<TargetHUD> implements ITargetVisual {
    ...
    public void render(@NotNull EntityLivingBase target) {
        ...
        RenderUtils.drawRoundedGradientOutlinedRectangle((float) minX, (float) minY, (float) maxX, (float) (maxY + 13), 10.0f, Utils.merge(Color.black.getRGB(), n11), Utils.merge(array[0], n10), Utils.merge(array[1], n10)); // outline
        final int n13 = minX + 6;
        final int n14 = maxX - 6;
        RenderUtils.drawRoundedRectangle((float) n13, (float) maxY, (float) n14, (float) (maxY + 5), 4.0f, Utils.merge(Color.black.getRGB(), n11)); // background
        ...
        RenderUtils.drawRoundedGradientRect((float) n13, (float) maxY, lastHealthBar, (float) (maxY + 5), 4.0f,
        ...
        if (healthColor.isToggled()) {
            ...
            RenderUtils.drawRoundedRectangle((float) n13, (float) maxY, lastHealthBar, (float) (maxY + 5), 4.0f, healthTextColor);
        }
